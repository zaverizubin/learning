...
{
	String uri = "amqps://snuwlowc:EgZbCF7EaGCU-hpEaMDDtlLNaD_-Tg-3@shark.rmq.cloudamqp.com/snuwlowc";
    ...
    public RabbitApp() throws KeyManagementException, NoSuchAlgorithmException, URISyntaxException, IOException {
    	buildConnection();
		this.queueManager = new QueueManager();
    }
    
    private void buildConnection() throws KeyManagementException, NoSuchAlgorithmException, URISyntaxException, IOException {
